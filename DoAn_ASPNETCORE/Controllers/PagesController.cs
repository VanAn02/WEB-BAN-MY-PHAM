...
namespace DoAn_ASPNETCORE.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        {
            var son = (from m in _context.SanPham
                          where m.IDMaLoai == id
                          select m).ToList();
        ...
        public async Task<IActionResult> detail(int? id)
        {
            ...
            var detail = (from m in _context.SanPham
                          where m.ID == id
                          select m).ToList();
        ...
        public IActionResult Single(int? id)
        {
            ...
            var Recent = (from m in _context.SanPham
                          where m.IDMaLoai == 2
                          select m).Take(4).ToList();
            ViewBag.Recent = Recent;
            var BetsSell = (from l in _context.SanPham
                            where l.IDHangsx == "CENTELLA"
        ...
        public async Task<IActionResult> search(String search)
        {
            ...
            var sch = from x in _context.SanPham select x;
            ViewBag.Username = HttpContext.Session.GetString("username");
